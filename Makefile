...
.PHONY: test-unit-8-3
test-unit-8-3: ## Run unit tests with PHP 8.3
	Build/Scripts/runTests.sh -s unit -p 8.3

.PHONY: test-unit-8-4
test-unit-8-4: ## Run unit tests with PHP 8.4 (highest supported by TYPO3 14)
	Build/Scripts/runTests.sh -s unit -p 8.4

.PHONY: test-unit
test-unit: test-unit-8-2 test-unit-8-4## Run unit tests with lowest and highest PHP versions

.PHONY: test-unit-all
test-unit-all: test-unit-8-2 test-unit-8-3 test-unit-8-4## Run all unit tests
...
test-functional-8-3: ## Run functional tests with PHP 8.3 and mariadb
	Build/Scripts/runTests.sh -s functional -p 8.3 -d mysql

.PHONY: test-functional-8-4
test-functional-8-4: ## Run functional tests with PHP 8.4 and mariadb (highest supported by TYPO3 14)
	Build/Scripts/runTests.sh -s functional -p 8.4 -d mysql

.PHONY: test-functional
test-functional: test-functional-8-2 test-functional-8-4## Run functional tests with lowest and highest PHP versions

.PHONY: test-functional-all
test-functional-all: test-functional-8-2 test-functional-8-3 test-functional-8-4## Run all functional tests
